        ...
        <div className="w-full justify-between gap-2 flex">
          <div>
            <div className="flex gap-3">
              ...
              <p className="text-lg text-white font-medium flex">Uploading</p>
            </div>
            <p className="text-white text-xs pl-8 pt-1 font-thin">Music</p>
            <p className="text-white text-xs pl-8 pt-1 font-thin">Cover Art</p>
          </div>
          <div>
        ...
        <div>
          <div className="flex gap-3">
            {!signed
              ...
              ? loadingStates[2].status
              : loadingStates[1].status}
            <p className="text-lg text-white font-medium flex">Created</p>
          </div>
          <p className="text-white text-xs pl-8 pt-1 font-thin">
            Confirming Player Creation
          </p>
        </div>
        <div>
          {!signed
